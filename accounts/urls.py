...
urlpatterns = [
    ...
    path("mypage/schedule-notices/", mypage_schedule_notices, name="mypage_schedule_notices"),
    path("mypage/sent-notices/", mypage_sent_notices, name="mypage_sent_notices"),
    ...
    path("mypage/community-guidelines/", community_guidelines, name="community_guidelines"),
