...
urlpatterns = [
    ...
    path("<int:band_id>/schedules/<int:schedule_id>/match/", views.schedule_match, name="schedule_match"),
    path("<int:band_id>/schedules/<int:schedule_id>/console/", views.schedule_console, name="schedule_console"),
    path("<int:band_id>/schedules/<int:schedule_id>/checkin/", views.schedule_checkin, name="schedule_checkin"),
    ...
    path("<int:band_id>/schedules/<int:schedule_id>/applications/<int:application_id>/demote/",
         views.schedule_demote, name="schedule_demote"),
